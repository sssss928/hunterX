...
Current fork version: `HunterX (0.4.4)`
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/build_windows.ps1 -Version 0.4.4
```

Expected output:

```text
dist/release/hunterX_windows_0.4.4.zip
```
...
For `v0.4.4`, the expected release artifacts are:

```text
hunterX_windows_0.4.4.zip
hunterX_source_0.4.4.zip
```
