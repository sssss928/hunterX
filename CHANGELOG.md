...
- Replace invalid release version flow with SemVer-based release workflow.
- Add CI, tests, security scans, dependency review, Dependabot, and benchmark baseline.
- Fix release URL and repository metadata.
- Add Windows build artifact workflow.

## Upstream inherited history
