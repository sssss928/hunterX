...
1. 前往 [GitHub Releases](https://github.com/sssss928/hunter/releases)
2. 下載最新版本的 ZIP 檔案（例如：`hunter_windows_2025.11.03.zip`）
3. 解壓縮到任意目錄
4. 開啟終端機，進入解壓縮後的目錄：
   ```bash
   cd tickets_hunter
...
**參考**：[Issue #7](https://github.com/sssss928/hunter/issues/7)
