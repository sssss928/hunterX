...
1. 開啟瀏覽器，前往 [Hunter Releases 頁面](https://github.com/sssss928/hunter/releases)
2. 找到最新版本（例如：`v2025.11.03`）
3. 下載 ZIP 檔案：`hunter_windows_XXXX.XX.XX.zip`
...
**步驟**：
1. 從 [GitHub Releases](https://github.com/sssss928/hunter/releases) 下載最新 ZIP
2. 解壓縮到新資料夾（或覆蓋舊版本）
