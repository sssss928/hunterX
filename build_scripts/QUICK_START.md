...
- `dist/release/hunterX_windows_0.4.5.zip` - 發布 ZIP
- `dist/release/test_report_0.4.5.txt` - 本機品質檢查摘要
...
│   └── CHANGELOG.md
└── release/
    ├── hunterX_windows_0.4.5.zip      ← 發布 ZIP
    └── test_report_0.4.5.txt          ← 本機品質檢查摘要
```
