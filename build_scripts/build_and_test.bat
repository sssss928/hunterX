@echo off
REM =============================================================================
REM Hunter - One-Click Build and Test Script
REM =============================================================================
...
echo.
echo ================================================================================
echo           Hunter - One-Click Build and Test
echo ================================================================================
echo.
...
echo   [2] Build executables with PyInstaller
...
xcopy /Y dist\nodriver_tixcraft\nodriver_tixcraft.exe dist\hunter\ >nul
xcopy /Y dist\settings\settings.exe dist\hunter\ >nul
echo [OK] 2 executables copied
echo.

echo [4.3] Merging _internal directories...
xcopy /E /I /Y dist\nodriver_tixcraft\_internal dist\hunter\_internal >nul
xcopy /E /I /Y dist\settings\_internal\* dist\hunter\_internal >nul
...
xcopy /E /I /Y src\assets dist\hunter\assets >nul 2>&1
echo   Copying www/ from src...
xcopy /E /I /Y src\www dist\hunter\www >nul 2>&1
...
set ZIP_NAME=hunter_windows_%VERSION%.zip
powershell -Command "Compress-Archive -Path 'dist\hunter\*' -DestinationPath 'dist\release\%ZIP_NAME%' -Force" >nul 2>&1
if %errorlevel% neq 0 (
...
(
    echo ================================================================================
    echo           Hunter - Build and Test Report
    echo ================================================================================
    echo.
