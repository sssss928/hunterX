...
FILL_STAGE = "fill"
SUBMIT_STAGE = "submit"
ROUTE_OBSERVATION_STAGE = "route_observation"
AREA_DOM_SNAPSHOT_STAGE = "area_dom_snapshot"
CANDIDATE_SELECTION_STAGE = "candidate_selection"
CANDIDATE_CLICK_STAGE = "candidate_click"
TICKET_READY_STAGE = "ticket_ready"
CAPTCHA_READY_STAGE = "captcha_ready"
REFRESH_DISPATCH_LATENESS_STAGE = "refresh_dispatch_lateness"
CORE_STAGE_ORDER = (
    ROUTE_OBSERVATION_STAGE,
    AREA_DOM_SNAPSHOT_STAGE,
    CANDIDATE_SELECTION_STAGE,
    CANDIDATE_CLICK_STAGE,
    TICKET_READY_STAGE,
    CAPTCHA_READY_STAGE,
    CAPTURE_STAGE,
    OCR_STAGE,
    FILL_STAGE,
    SUBMIT_STAGE,
    REFRESH_DISPATCH_LATENESS_STAGE,
)
