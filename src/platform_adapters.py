        ...
        *_identity("funone"),
        (
            _rules(
                ...
                "/sales/",
                "/ticket",
                "/purchase_choose_ticket",
                "/purchase_choose_area",
            ),
            _rules(PageClass.DATE, "/events/", "/activity/activity_detail/"),
            _rules(PageClass.ACTIVITY, "/events/", "/activity/activity_detail/"),
        ),
        (
            _rules(PageClass.QUEUE, "/purchase_waiting_jump/"),
            _rules(PageClass.PAYMENT, "/payment", "/purchase_checkout"),
            _rules(PageClass.CHECKOUT, "/checkout"),
            _rules(PageClass.ORDER, "/orders/", "/purchase_fill_form"),
        ),
        _COMPLETE,
    ),
    DeclarativePlatformAdapter(
        ...
        *_identity("hkticketing"),
        (
            _rules(
                ...
                "/performance",
                "/secure/selection",
                "#/allevents/detail/selectticket",
            ),
            _rules(PageClass.DATE, "/events/", "/event/", "#/allevents/detail/"),
            _rules(PageClass.ACTIVITY, "/events/", "/event/"),
        ),
        (
            _rules(PageClass.PAYMENT, "/payment", "#/generateseat"),
            _rules(PageClass.CHECKOUT, "/checkout"),
            _rules(PageClass.ORDER, "/order", "#/confirmorder"),
        ),
        _COMPLETE,
    ),
)
